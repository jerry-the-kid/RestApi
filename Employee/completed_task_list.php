        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="completed_task_list.php">Completed Task<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
...
<script>
    ...
    function loadProduct(){
        $.post("http://localhost/final/api/get_completed_task_employee.php",{id : 14}, function(data, status) {
            $('.table-body').html('');
