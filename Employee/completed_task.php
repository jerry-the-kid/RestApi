        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="completed_task_list.html">Completed Task<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
...
<script>
    ...
    $(document).ready(function () {
        $.get('../api/get-task.php', {id : idTask}).done(function (response) {
            ...
            $('#danh_gia').append(`<span class = 'badge badge-success p-2'>Ok</span>`);
